...
import {
	...
	getOrganizationsSlugMembersRolePathParamsRoleEnum,
	usePostOrganizationsSlugInvites,
} from "@/http/generated";
...
const InviteMemberSchema = z
	.object({
		...
		role: z
			.enum(getOrganizationsSlugMembersRolePathParamsRoleEnum)
			.default("MEMBER"),
	})
	.required();
...
export function InviteMemberWithEmailAndRole() {
	...
	const { handleSubmit, reset, control } = useForm<InviteMemberType>({
	...
	return (
		...
		>
			...
			<p className="text-xs text-muted-foreground">
				Após o membro aceitar o convite, você pode definir o acesso por empresa
				e unidade na lista de membros.
			</p>
		</form>
	);
}
