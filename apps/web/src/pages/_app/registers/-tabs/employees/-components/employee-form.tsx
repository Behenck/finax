...
export function EmployeeForm({ onSuccess, mode, initialData }: CreateEmployeeFormProps) {
              ...
              <Field data-invalid={fieldState.invalid} className="gap-1">
                ...
                <div>
                  <Input
                    ...
                    autoCorrect="off"
                    aria-invalid={fieldState.invalid}
                    aria-describedby={fieldState.invalid ? "department-error" : undefined}
                ...
                {fieldState.invalid && (
                  <FieldError id="department-error" errors={[fieldState.error]} />
                )}
              </Field>
            )}
          />
