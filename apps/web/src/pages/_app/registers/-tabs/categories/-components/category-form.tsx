...
const AVAILABLE_ICONS = [
  "MoreHorizontal", "Utensils", "ShoppingBag", "ShoppingCart", "Coffee", "Home", "Car", "Plane", "Train",
  "CreditCard", "Wallet", "PiggyBank", "Landmark", "TrendingUp", "TrendingDown", "DollarSign",
  "GraduationCap", "Book", "Gamepad2", "Music", "Film", "Tv", "Smartphone", "Laptop",
  "HeartPulse", "Stethoscope", "Dumbbell", "Bike", "Running", "Shirt", "Baby", "Gamepad",
  "Briefcase", "Building", "Wrench", "Hammer", "Paintbrush", "Palette", "Camera", "Headphones",
  "Gift", "Cake", "Beer", "Wine", "Pizza", "IceCream", "Users", "User", "Heart", "Smile",
  "AlertTriangle", "Shield", "Lock", "Key", "Bell", "Mail", "Phone", "MessageSquare",
  "Repeat", "RefreshCw", "ArrowLeftRight", "ArrowUpDown", "Settings"
];
            ...
            <Field data-invalid={fieldState.invalid} className="gap-1">
              ...
              <div>
                <Input
                  ...
                  onChange={(event) => {
                    const formattedValue = formatCategoryCode(event.target.value)
                    field.onChange(formattedValue)
                  }}
                />
              </div>
                    ...
                    <div className="relative flex items-center">
                      ...
                      >
                        <Palette className={cn(
                          "size-5",
                          field.value ? "text-white drop-shadow-md" : "text-gray-600"
                        )} />
                        <input
