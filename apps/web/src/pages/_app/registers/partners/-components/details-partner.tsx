      ...
      <DialogContent className="space-y-2">
        ...
        <div className="flex gap-4">
          <Avatar className="rounded-md! w-full h-full max-w-24">
            <AvatarImage src="" />
            <AvatarFallback className="rounded-md!">{getInitials(partner.name)}</AvatarFallback>
          </Avatar>
        ...
        <div className="flex flex-col gap-2">
          ...
          {partner.phone && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-light">{formatPhone(partner.phone)}</span>
            </div>
          )}
          {partner.companyName && (
            <div className="flex items-center gap-2">
          ...
          {partner.document && (
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-light">{formatDocument({ type: partner.documentType, value: partner.document })}</span>
            </div>
          )}
        </div>
        <Separator />
        ...
        {partner.supervisor && (
          <>
            <Separator />
            <div className="flex flex-col gap-2">
              <h3 className="font-normal mb-2 uppercase">Supervisor</h3>
