...
import {
	getOrganizationsSlugSellersQueryKey,
	usePostOrganizationsSlugSellers,
	usePutOrganizationsSlugSellersSellerid,
	type GetOrganizationsSlugSellersSellerid200,
} from "@/http/generated";
...
export function FormSeller({ type = "CREATE", seller }: FormSellerProps) {
	...
	const { mutateAsync: createSeller } = usePostOrganizationsSlugSellers();
			...
			<form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
				...
				<div className="hidden justify-end gap-2 md:flex">
					<Button type="button" variant="outline" asChild>
						<Link to="/registers/sellers">Cancelar</Link>
					</Button>
					<Button type="submit">
						{type === "CREATE" ? "Cadastrar Vendedor" : "Atualizar Vendedor"}
					</Button>
				</div>
