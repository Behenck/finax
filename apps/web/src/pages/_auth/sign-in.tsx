  ...
  return (
    <div className='w-full max-w-md space-y-8 animate-fade-in'>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <Button type='submit' className='w-full h-10 text-md flex items-center gap-3'>
          Entrar
          <ArrowRight className='size-5' />
        </Button>
        <p className="flex gap-2 items-center justify-center text-sm text-muted-foreground">
          Não tem uma conta?
          <Link className="text-primary font-medium hover:underline" to="/sign-up">Cadastre-se</Link>
        </p>
      </form>
    </div>
  )
