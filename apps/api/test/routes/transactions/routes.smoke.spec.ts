...
describe("transactions routes smoke", () => {
  beforeAll(async () => {
  ...
  it("DELETE /organizations/:slug/transactions/:transactionId should be registered", async () => {
  ...
  it("GET /organizations/:slug/transactions/:transactionId should be registered", async () => {
    const url = fillPathParams("/organizations/:slug/transactions/:transactionId")
    const agent = request(app.server)
  ...
  it("PATCH /organizations/:slug/transactions/:transactionId should be registered", async () => {
    const url = fillPathParams("/organizations/:slug/transactions/:transactionId")
    const agent = request(app.server)
  ...
  it("GET /organizations/:slug/transactions should be registered", async () => {
    const url = fillPathParams("/organizations/:slug/transactions")
    const agent = request(app.server)
    const response = await agent.get(url)
  ...
  it("POST /organizations/:slug/transactions should be registered", async () => {
    const url = fillPathParams("/organizations/:slug/transactions")
    const agent = request(app.server)
