...
type SaleHistoryDbClient = Pick<Prisma.TransactionClient, "sale" | "saleHistoryEvent">;
...
export async function createSaleDiffHistoryEvent(
	...
	const changes = buildSaleHistoryDiff(input.beforeSnapshot, input.afterSnapshot);
